...
public class DAOPeliculaMysql {
    ...
    /****************************************************************************************************************
     * ALTAPELICULA, para el caso de una tabla con índice autoincremental
     * @param miPelicula  pelicula con los nuevos datos
     */
    public void altaPelicula_Autoincremental(Pelicula miPelicula) {
        conectar();
        try {

            // creamos un string con la instruccion SQL que ejecutamos,
            // y ponemos ? en los sitios donde va a haber valores variables
            // pero NO en el índice, pues es autoincremental.
            // En el índice ponemos directamente un 0
            String sql = "INSERT INTO PELICULA VALUES (0,?,?)  ";  // si el campo no es NOT NULL, puede ponerse NULL en vez de 0
            ...
            // SI QUEREMOS SABER qué índice autoincremental se ha creado y añadido a la tabla....
            int idcreado = -1;
