...
public class CrearYLanzarProcesoSimple_ConProcessBuilder {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            // Si queremos, podemos FUNDIR la salida del primer proceso con la del segundo, asi, directamente
            obProBuil.inheritIO();
            ...
            ex.printStackTrace();
            ProcessBuilder obProBuil2 = new ProcessBuilder( "ls" , "-l" );
            obProBuil2.redirectOutput(new File("salida.txt"));
            Process obProcesoHijo = obProBuil2.start();
