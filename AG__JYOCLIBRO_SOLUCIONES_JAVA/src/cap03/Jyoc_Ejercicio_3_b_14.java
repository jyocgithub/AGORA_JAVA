 ...
 */
public class Jyoc_Ejercicio_3_b_14 {

     public static void main(String[] args) {
          int numero = 0, intentos = 0, prueba=0;
          Scanner sc = new Scanner(System.in);

          System.out.println("cap50_a_12_MundialBaloncesto.clases.Jugador 1, indique un numero entre 1 y 100");
          numero = sc.nextInt();
          boolean adivinado = false;

          while (!adivinado && intentos < 11) {

               System.out.println("cap50_a_12_MundialBaloncesto.clases.Jugador 2, indique un numero a ver si acierta:");
               prueba = sc.nextInt();
               if(prueba==numero){
