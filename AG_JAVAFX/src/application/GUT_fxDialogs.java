...
public class GUT_fxDialogs {
    ...
    public  static void mensajeConfirmacion(String texto) {
    ...
    public void mensajeConTextArea(String res){
        JTextArea textArea = new JTextArea(res);
        textArea.setColumns(30);
        textArea.setLineWrap(true);
        textArea.setWrapStyleWord(true);
        textArea.setSize(textArea.getPreferredSize().width, 1);
        JOptionPane.showMessageDialog(null, new JScrollPane( textArea), "TITULO",
